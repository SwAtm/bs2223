...
echo "<tr><td>$led[id]</td><td>$led[name]-$led[city]</td><td>$led[obl]</td><td>$sales</td><td>$purchase</td><td>$led[rpt]</td><td>$led[pmt]</td><td><a href =".site_url('Party_trans/ind_ledger/'.$led['id']).">$balance</a></td></tr>";
endforeach;
//print_r($ledger);
echo "</table>";
?>
